...
const UserEmailUpdate = () => {
  ...
  const { currentEmail,updateUserEmail, loading, error, successMsg } = useUserEmailUpdate();
  ...
  return (
    <div className="max-w-md mx-auto bg-white p-6 shadow rounded">
      ...
      <div>
          <label className="block text-sm font-bold mb-2">Current Email</label>
          <input
            type="email"
            value={currentEmail}
            disabled
      ...
      {error && <p className="text-red-600 mt-3">Email update failed: {error}</p>}
